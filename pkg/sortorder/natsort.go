...
// skipZeros advances i past any ASCII '0' bytes in s.
...
// skipDigits advances i past any ASCII digit bytes in s.
...
func NaturalLess(str1, str2 string) bool {
	...
	for idx1 < len(str1) && idx2 < len(str2) {
		...
		case !dig1: // && !dig2, because dig1 == dig2
			...
			idx2++
		default: // Digits
			idx1 = skipZeros(str1, idx1)
			idx2 = skipZeros(str2, idx2)
			nonZero1, nonZero2 := idx1, idx2
			idx1 = skipDigits(str1, idx1)
			idx2 = skipDigits(str2, idx2)
