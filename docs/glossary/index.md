...
publishing entirely. See [Registry concepts](../registry/index.md).
...
[Dependencies](../wpm-json/dependencies.md).
...
admin UI. See [Package types](../package-types/index.md).
...
`^[a-z0-9]+(-[a-z0-9]+)*$`. See [`wpm.json` reference](../wpm-json/index.md).
...
it. See [Package types](../package-types/index.md).
...
are `name`, `version`, `type`. See [`wpm.json` reference](../wpm-json/index.md).

## wpm.lock

The lockfile. See _Lockfile_ and [`wpm.lock`](../wpm-lock/index.md).

## .wpmignore

A gitignore-style file controlling which paths `wpm publish` includes in the
published tarball. Optional. See [`.wpmignore`](../wpmignore/index.md).
